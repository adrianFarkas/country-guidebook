    ...
    return (
        <div className="detail-card">
            ...
            <div className="detail-card-left-div">
                ...
                Education in Hungary is predominantly public, run by the Ministry of Human Resources. Preschool
            ...
            <div className="detail-card-right-div">
                ...
                <img
                    src="https://d3fy651gv2fhd3.cloudfront.net/charts/hungary-public-spending-on-education-total-percent-of-government-expenditure-wb-data.png?s=hun.se.xpd.totl.gb.zs%3aworldbank&lbl=0&v=201910310000V20190821"
                    className="details-card-right-images"/>

                <h4>Federal educational system</h4>
                <img
                    src="https://slideplayer.com/slide/12739656/77/images/4/Hungarian+educational+system.jpg"
                    className="details-card-right-images"/>
                <h4>2020 education index</h4>
                <img
                    src="http://budapestbeacon.com/wp-content/uploads/2014/09/WEF2014.png"
                    className="details-card-right-images"/>
