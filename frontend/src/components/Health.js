    ...
    return (
        <div className="detail-card">
            ...
            <div className="detail-card-left-div">
                ...
                Állami Szívkórház ("State Heart Hospital") in Balatonfüred, resort town by Lake Balaton Hungary has a
            ...
            <div className="detail-card-right-div">
                ...
                <img
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Balatonf%C3%BCred%2C_Sz%C3%ADvk%C3%B3rh%C3%A1z.jpg/1920px-Balatonf%C3%BCred%2C_Sz%C3%ADvk%C3%B3rh%C3%A1z.jpg"
                    className="details-card-right-images"/>

                <h4>Termal Spa in Hungary</h4>
                <img
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/H%C3%A9v%C3%ADz_1.jpg/1920px-H%C3%A9v%C3%ADz_1.jpg"
                    className="details-card-right-images"/>
                <h4>Main hospitals in Hungary</h4>
                <img
                    src="https://www.jewishgen.org/yizkor/Brichah/images/bri138.jpg"
                    className="details-card-right-images"/>
